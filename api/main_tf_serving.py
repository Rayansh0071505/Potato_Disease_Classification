...
# pred_MODEL = tf.keras.models.load_model("C:/Users/Amit/Desktop/others/Data science/Projects/Potato disease prediction/2")
...
async def predict(
    ...
    json_data = {
        "instances":img_batch.tolist()  # for tf serving we need instance so we need to make json data
    }
